        ...
        <table border="1">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="categoria-salvar.php?acao=salvar$id=<?php echo $dado['CategoriaID'];?>"></a><?php echo $dado['Nome'];?></td>
                    <td><a href="categoria-processo.php?acao=excluir&id=<?php echo $dado['CategoriaID']?>">Excluir</a></td>
                </tr>
            <?php 
                }
            }else{    
